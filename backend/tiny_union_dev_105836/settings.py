"""
Django settings for tiny_union_dev_105836 project.
...
ROOT_URLCONF = 'tiny_union_dev_105836.urls'
...
WSGI_APPLICATION = 'tiny_union_dev_105836.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tiny_union_dev_105836 API",
    "DESCRIPTION": "API documentation for tiny_union_dev_105836 App",
    "VERSION": "v1",
}
